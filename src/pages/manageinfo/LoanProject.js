...
function LoanProject () {
    ...
    const rowsLabel = [
        'ProjectCode', 'ProjectName', 'SubProjectCode', 'SubProjectName', 'ProvinceName', 'PlanYear', 'ProvinceIDName', 'ProvinceID'
    ]

    const headCells = [
        { id: 'ProjectCode', numeric: false, disablePadding: true, widthCol: '60px', label: 'รหัสโครงการ' },
        { id: 'ProjectName', numeric: false, disablePadding: true, widthCol: '160px', label: 'ชื่อโครงการ' },
        { id: 'SubProjectCode', numeric: false, disablePadding: true, widthCol: '100px', label: 'รหัสโครงการรอง' },
        { id: 'SubProjectName', numeric: false, disablePadding: true, widthCol: '160px', label: 'ชื่อโครงการรอง' },
        { id: 'ProvinceName', numeric: false, disablePadding: true, widthCol: '160px', label: 'ชื่อจังหวัด' },
        { id: 'PlanYear', numeric: false, disablePadding: true, widthCol: '160px', label: 'แผนปี' },
        { id: 'ProvinceIDName', numeric: false, disablePadding: true, widthCol: '160px', label: 'ชื่อรหัสจังหวัด' },
        { id: 'ProvinceID', numeric: false, disablePadding: true, widthCol: '160px', label: 'รหัสจังหวัด' },
    ]

    function createData(ProjectCode, ProjectName, SubProjectCode, SubProjectName, ProvinceName, PlanYear, ProvinceIDName, ProvinceID) {
        return {ProjectCode, ProjectName, SubProjectCode, SubProjectName, ProvinceName, PlanYear, ProvinceIDName, ProvinceID}
    }
                    ...
                    <Container maxWidth="md">
                        <Grid container spacing={2}>
                            <Grid item xs={12} md={12} className="title-page"> 
                                <h1>โครงการกู้เงิน</h1>
                            </Grid>
                            <Grid item xs={12} md={3}>
                                <MuiTextfield label="รหัสโครงการ" name="ProjectCode" value={inputDataSearch.ProjectCode} onChange={handleInputDataSearch} />
                            </Grid>
                            <Grid item xs={12} md={3}>
                                <MuiTextfield label="ชื่อโครงการ" name="ProjectName" value={inputDataSearch.ProjectName} onChange={handleInputDataSearch} />
                            </Grid>
                            <Grid item xs={12} md={3}>
                                <MuiTextfield label="รหัสโครงการรอง" name="SubProjectCode" value={inputDataSearch.SubProjectCode} onChange={handleInputDataSearch} />
                            </Grid>
                            <Grid item xs={12} md={3}>
                                <MuiTextfield label="ชื่อโครงการรอง" name="SubProjectName" value={inputDataSearch.SubProjectName} onChange={handleInputDataSearch} />
                            </Grid>
                            <Grid item xs={12} md={3}>
                                <MuiTextfield label="ชื่อจังหวัด" name="ProvinceName" value={inputDataSearch.ProvinceName} onChange={handleInputDataSearch} />
                            </Grid>
                            <Grid item xs={12} md={3}>
                                <MuiTextfield label="แผนปี" name="PlanYear" value={inputDataSearch.PlanYear} onChange={handleInputDataSearch} />
                            </Grid>
                            <Grid item xs={12} md={3}>
                                <MuiTextfield label="ชื่อรหัสจังหวัด" name="ProvinceIDName" value={inputDataSearch.ProvinceIDName} onChange={handleInputDataSearch} />
                            </Grid>
                            <Grid item xs={12} md={3}>
