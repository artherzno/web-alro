...
function InfoFarmer () {
    ...
    const headCells = [
        { id: 'f1', numeric: false, disablePadding: true, widthCol: '160px', label: 'บัตรประชาชน' },
        { id: 'f2', numeric: false, disablePadding: true, widthCol: '60px', label: 'คำนำหน้า' },
        { id: 'f3', numeric: false, disablePadding: true, widthCol: '160px', label: 'ชื่อ' },
        { id: 'f4', numeric: false, disablePadding: true, widthCol: '160px', label: 'นามสกุล' },
        { id: 'f5', numeric: false, disablePadding: true, widthCol: '160px', label: 'เลขที่' },
        { id: 'f6', numeric: false, disablePadding: true, widthCol: '160px', label: 'หมู่' },
        { id: 'f7', numeric: false, disablePadding: true, widthCol: '160px', label: 'ตำบล' },
        { id: 'f8', numeric: false, disablePadding: true, widthCol: '160px', label: 'อำเภอ' },
        { id: 'f9', numeric: false, disablePadding: true, widthCol: '160px', label: 'จังหวัด' },
    ]

    function createData(f1, f2, f3, f4, f5, f6, f7, f8, f9 ) {
                    ...
                    <Container maxWidth="md">
                        <Grid container spacing={2}>
                            ...
                            {/* <Grid item xs={12} md={3}>
                                <MuiTextfield label="" name="ProvinceID" value={inputDataSearch.ProvinceID} onChange={handleInputDataSearch} />
                            </Grid>
                            <Grid item xs={12} md={3}>
                                <MuiTextfield label="ประเภทกู้ยืม" name="Code" value={inputDataSearch.Code} onChange={handleInputDataSearch} />
                            </Grid>
                            <Grid item xs={12} md={3}>
                                <p>&nbsp;</p>
                    ...
                    <Container maxWidth={false}>
...

                        {
                            formField ? 
                                <Grid item xs={12} md={12}>
                                    <Grid item xs={12} md={12} className="title-page"> 
                                        <h1 className="txt-green">ประเภทกู้ยืม</h1>
                                    </Grid>
