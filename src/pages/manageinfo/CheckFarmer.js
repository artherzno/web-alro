...
function CheckFarmer () {
    ...
    const headCells = [
        { id: 'c1', numeric: false, disablePadding: true, widthCol: '60px', label: 'รหัสบันทึก' },
        { id: 'c2', numeric: false, disablePadding: true, widthCol: '160px', label: 'วันที่บันทึก' },
        { id: 'c3', numeric: false, disablePadding: true, widthCol: '160px', label: 'คำนำหน้า' },
        { id: 'c4', numeric: false, disablePadding: true, widthCol: '160px', label: 'ชื่อ' },
        { id: 'c5', numeric: false, disablePadding: true, widthCol: '160px', label: 'นามสกุล' },
        { id: 'c6', numeric: false, disablePadding: true, widthCol: '160px', label: 'บัตรประชาชน' },
        { id: 'c7', numeric: false, disablePadding: true, widthCol: '160px', label: 'ที่อยู่' },
        { id: 'c8', numeric: false, disablePadding: true, widthCol: '160px', label: 'ที่อยู่จัดส่งเอกสาร' },
        { id: 'c9', numeric: false, disablePadding: true, widthCol: '160px', label: 'โทรศัพท์' },
        { id: 'c10', numeric: false, disablePadding: true, widthCol: '160px', label: 'Num' },
        { id: 'c11', numeric: false, disablePadding: true, widthCol: '160px', label: 'พื้นที่' },
    ]

    function createData(c1, c2, c3, c4, c5, c6, c7, c8, c9, c10, c11 ) {
                    ...
                    <Container maxWidth="md">
                        <Grid container spacing={2}>
                            <Grid item xs={12} md={12} className="title-page"> 
                                <h1>ตรวจสอบรายละเอียด(เกษตรกร)</h1>
                            </Grid>
                            <Grid item xs={12} md={3}>
                                <MuiTextfield label="ชื่อเกษตรกร" name="ProvinceID" value={inputDataSearch.ProvinceID} onChange={handleInputDataSearch} />
                            </Grid>
                            <Grid item xs={12} md={3}>
                                <MuiTextfield label="เลขบัตรประชาชน" name="Code" value={inputDataSearch.Code} onChange={handleInputDataSearch} />
                            </Grid>
                            <Grid item xs={12} md={3}>
                                <p>&nbsp;</p>
                            ...
                            <Grid item xs={12} md={3}>
                                <p>&nbsp;</p>
                                <ButtonFluidPrimary label="ดูทั้งหมด" />  
                            </Grid>
                            {/* <Grid item xs={12} md={3}>
                                <p>&nbsp;</p>
                    ...
                    <Container maxWidth={false}>
...

                        {
                            formField ? 
                                <Grid item xs={12} md={12}>
                                    <Grid item xs={12} md={12} className="title-page"> 
                                        <h1 className="txt-green">เงื่อนไขการปรับโครงสร้างหนี้</h1>
                                    </Grid>
