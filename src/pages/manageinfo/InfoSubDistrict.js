...
function InfoSubDistrict () {
    ...
    const rowsLabel = [
        'SubDistrictID', 'SubDistrictName', 'DistrictName', 'ProvinceName'
    ]

    const headCells = [
        { id: 'SubDistrictID', numeric: false, disablePadding: true, widthCol: '60px', label: 'รหัสตำบล' },
        { id: 'SubDistrictName', numeric: false, disablePadding: true, widthCol: '100px', label: 'ชื่อตำบล' },
        { id: 'DistrictName', numeric: false, disablePadding: true, widthCol: '100px', label: 'ชื่ออำเภอ' },
        { id: 'ProvinceName', numeric: false, disablePadding: true, widthCol: '160px', label: 'ชื่อจังหวัด' },
    ]

    function createData(SubDistrictID, SubDistrictName, DistrictName, ProvinceName) {
        return {SubDistrictID, SubDistrictName, DistrictName, ProvinceName}
    }
                    ...
                    <Container maxWidth="md">
                        <Grid container spacing={2}>
                            ...
                            <Grid item xs={12} md={2}>
                                <MuiTextfield label="รหัสตำบล" name="SubDistrictID" value={inputDataSearch.SubDistrictID} onChange={handleInputDataSearch} />
                            </Grid>
                            <Grid item xs={12} md={2}>
                                <MuiTextfield label="ชื่อตำบล" name="SubDistrictName" value={inputDataSearch.SubDistrictName} onChange={handleInputDataSearch} />
                            </Grid>
                            <Grid item xs={12} md={2}>
                                <MuiTextfield label="ชื่ออำเภอ" name="DistrictName" value={inputDataSearch.DistrictName} onChange={handleInputDataSearch} />
                            </Grid>
                            <Grid item xs={12} md={2}>
...
export default InfoSubDistrict
