...
function LoanPeriod () {
    ...
    const rowsLabel = [
        'LoanPeriodID', 'LoanPeriod', 'Notice'
    ]

    const headCells = [
        { id: 'LoanPeriodID', numeric: false, disablePadding: true, widthCol: '60px', label: 'รหัสระยะเวลา' },
        { id: 'LoanPeriod', numeric: false, disablePadding: true, widthCol: '160px', label: 'ระยะเวลา' },
        { id: 'Notice', numeric: false, disablePadding: true, widthCol: '100px', label: 'หมายเหตุ' },
    ]

    function createData(LoanPeriodID, LoanPeriod, Notice ) {
        return {LoanPeriodID, LoanPeriod, Notice }
    }

    useEffect(() => {
        setRows([
            {LoanPeriodID: 'ส', LoanPeriod: 'เงินกู้ระยะสั้น', Notice: 'กำหนดชำระคืน ภายใน 1ปี'},
            {LoanPeriodID: 'ก', LoanPeriod: 'เงินกู้ระยะกลาง', Notice: 'กำหนดชำระคืน ภายใน 3ปี'},
            {LoanPeriodID: 'ย', LoanPeriod: 'เงินกู้ระยะยาว', Notice: 'กำหนดชำระคืน มากกว่า 3ปี'}
        ])
        setLoaded(true);
                ...
                <div className="fade">
                    <Container maxWidth="md">
                        <Grid container spacing={2}>
                            ...
                            <Grid item xs={12} md={3}>
                                <MuiTextfield label="ระยะเวลา" name="Code" value={inputDataSearch.Code} onChange={handleInputDataSearch} />
                            </Grid>
                            <Grid item xs={12} md={3}>
                                <p>&nbsp;</p>
                    ...
                    <Container maxWidth={false}>
...

                        {
                            formField ? 
                                <Grid item xs={12} md={12}>
                                    <Grid item xs={12} md={12} className="title-page"> 
                                        <h1 className="txt-green">ระยะเวลาเงินกู้</h1>
                                    </Grid>
