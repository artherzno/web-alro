...
function InfoDistrict () {
    ...
    const rowsLabel = [
        'DistrictID', 'DistrictName', 'ProvinceName'
    ]

    const headCells = [
        { id: 'DistrictID', numeric: false, disablePadding: true, widthCol: '60px', label: 'รหัสอำเภอ' },
        { id: 'DistrictName', numeric: false, disablePadding: true, widthCol: '100px', label: 'ชื่ออำเภอ' },
        { id: 'ProvinceName', numeric: false, disablePadding: true, widthCol: '160px', label: 'Am_pv_name' },
    ]

    function createData(DistrictID, DistrictName, ProvinceName) {
        return {DistrictID, DistrictName, ProvinceName}
    }
