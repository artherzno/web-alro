...
function LoanType () {
    ...
    const headCells = [
        { id: 'LoanTypeID', numeric: false, disablePadding: true, widthCol: '60px', label: 'รหัสประเภท' },
        { id: 'LoanTypeName', numeric: false, disablePadding: true, widthCol: '160px', label: 'ประเภทกู้ยืม' },
    ]

    function createData(LoanTypeID, LoanTypeName, ) {
        return {LoanTypeID, LoanTypeName}
    }
    

    useEffect(() => {
        setRows([
            {LoanTypeID: '01', LoanTypeName: 'รายบุคคล'},
            {LoanTypeID: '02', LoanTypeName: 'รายโครงการ'}
        ])
        setLoaded(true);
                    ...
                    <Container maxWidth="md">
                        <Grid container spacing={2}>
                            ...
                            <Grid item xs={12} md={3}>
                                <MuiTextfield label="รหัสประเภท" name="ProvinceID" value={inputDataSearch.ProvinceID} onChange={handleInputDataSearch} />
                            </Grid>
                            <Grid item xs={12} md={3}>
