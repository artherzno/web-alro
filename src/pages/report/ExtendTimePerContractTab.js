...
class ExtendTimePerContractTab extends React.Component {
...
parameter.append('YearTo', YearTovalue);
        ...
        api.getExtendtimePerContract(parameter).then(response => {
...
parameter.append('YearTo', YearTovalue);
        ...
        api.exportExtendtimePerContract(parameter).then(response => {

            const url = window.URL.createObjectURL(new Blob([response.data]));
            const link = document.createElement('a');
            link.href = url;
            link.setAttribute('download', 'รายงานการขยายเวลา.xlsx');
    ...
    render() {
        ...
        return (<div>
            ...
            <div>
                <Box mt={1} mb={5}>
                    <Typography variant="h6" align="center">รายงานการขยายเวลา {`${this.state.provinceZoneLabel}`}</Typography>
...
export default withStyles(styles)(ExtendTimePerContractTab)