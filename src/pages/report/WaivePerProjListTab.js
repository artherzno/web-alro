...
class WaivePerProjListTab extends React.Component {
...
parameter.append('YearTo', YearTovalue);
        ...
        api.getWaivePerProList(parameter).then(response => {
...
parameter.append('YearTo', YearTovalue);
        ...
        api.exportWaivePerProjList(parameter).then(response => {

            const url = window.URL.createObjectURL(new Blob([response.data]));
            const link = document.createElement('a');
            link.href = url;
            link.setAttribute('download', 'รายงานการขอผ่อนผัน(รายโครงการ).xlsx');
    ...
    render() {
        ...
        return (<div>
            ...
            <div>
                <Box mt={1} mb={5}>
                    <Typography variant="h6" align="center">รายงานการขอผ่อนผัน (รายโครงการ) {`${this.state.provinceZoneLabel}`}</Typography>
...
export default withStyles(styles)(WaivePerProjListTab)