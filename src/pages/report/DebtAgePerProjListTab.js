...
class DebtAgePerProjListTab extends React.Component {
...
parameter.append('YearTo', YearTovalue);
        ...
        api.getDebtAgeByProject(parameter).then(response => {
    ...
    exportExcel() {
        ...
        api.exportDebtAgePerProjList(parameter).then(response => {

            const url = window.URL.createObjectURL(new Blob([response.data]));
            const link = document.createElement('a');
            link.href = url;
            link.setAttribute('download', 'รายงานอายุหนี้(รายโครงการ).xlsx');
    ...
    printPDF() {
        ...
        api.getDebtAgeByProjectPdf(parameter).then(response => {
    ...
    render() {
        ...
        return (<div>
            ...
            <div>
                <Box mt={1} mb={5}>
                    <Typography variant="h6" align="center">รายงานอายุหนี้ (รายโครงการ) {`${this.state.provinceZoneLabel}`}</Typography>
                        ...
                        <Table className={classes.table} aria-label="customized table">
                            <TableHead>
                                <TableRow>
                                    ...
                                    <StyledTableCell align="center" rowSpan={2}>รหัสโครงการ</StyledTableCell>
...
export default withStyles(styles)(DebtAgePerProjListTab)