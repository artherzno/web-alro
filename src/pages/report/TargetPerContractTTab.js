...
class TargetPerContractTTab extends React.Component {
    ...
    loadPayLoan(page, count) {
        ...
        api.getTargetByContract(parameter).then(response => {
    ...
    exportExcel() {
        ...
        api.exportTargetByContract(parameter).then(response => {
            ...
            link.href = url;
            link.setAttribute('download', 'รายงานเป้าจัดเก็บรายสัญญา_ตำบล.xlsx');
    ...
    printPDF() {
        ...
        api.getTargetByContractPdf(parameter).then(response => {
    ...
    render() {
        ...
        return (<div>
            ...
            <div>
                <Box mt={1} mb={5}>
                    <Typography variant="h6" align="center">รายงานเป้าจัดเก็บ รายสัญญา(ตำบล) {`${this.state.provinceZoneLabel}`}</Typography>
                        ...
                        <Table className={classes.table} aria-label="customized table">
                            <TableHead>
                                <TableRow>
                                    ...
                                    <StyledTableCell align="center" rowSpan={2}>ชื่อตำบล</StyledTableCell>
                            ...
                            <TableBody>
                                {this.state.farmerPayLoanList.map((farmer, index) => {
                                    ...
                                    return (
                                        <TableRow key={index}>
                                            <StyledTableCellLine align="left">{farmer.subDistrict}</StyledTableCellLine>
...
export default withStyles(styles)(TargetPerContractTTab)