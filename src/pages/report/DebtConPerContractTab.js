...
class DebtConPerContractTab extends React.Component {
...
parameter.append('YearTo', YearTovalue);
        ...
        api.exportRequestLoan(parameter).then(response => {
            ...
            link.href = url;
            link.setAttribute('download', 'รายงานสภาพหนี้.xlsx');
    ...
    render() {
        ...
        return (<div>
            ...
            <div>
                <Box mt={1} mb={5}>
                    <Typography variant="h6" align="center">รายงานสภาพหนี้ {`${this.state.provinceZoneLabel}`}</Typography>
...
export default withStyles(styles)(DebtConPerContractTab)