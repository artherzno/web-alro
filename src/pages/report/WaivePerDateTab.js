...
class WaivePerDateTab extends React.Component {
...
parameter.append('YearTo', YearTovalue);
        ...
        api.getExtend(parameter).then(response => {
...
parameter.append('YearTo', YearTovalue);
        ...
        api.exportWaivePerDate(parameter).then(response => {

            const url = window.URL.createObjectURL(new Blob([response.data]));
            const link = document.createElement('a');
            link.href = url;
            link.setAttribute('download', 'สุรปสัญญาที่ขอผ่อนผันการชำระหนี้.xlsx');
    ...
    render() {
        ...
        return (<div>
            ...
            <div>
                <Box mt={1} mb={5}>
                    <Typography variant="h6" align="center">สุรปสัญญาที่ขอผ่อนผันการชำระหนี้ {`${this.state.provinceZoneLabel}`}</Typography>
                    ...
                    <Table className={classes.table} aria-label="customized table">
                            <TableHead>
                                <TableRow>
                                    ...
                                    <StyledTableCell align="center">ว /ด /ปี สัญญา</StyledTableCell>
                                    <StyledTableCell align="center">งบปี</StyledTableCell>
                                    <StyledTableCell align="center">วงเงินกู้</StyledTableCell>
                                    <StyledTableCell align="center">เงินกู้คงเหลือ</StyledTableCell>
                                    <StyledTableCell align="center">ประเภท</StyledTableCell>
                                    <StyledTableCell align="center">ว/ด/ป งวดชำระ</StyledTableCell>
                                    <StyledTableCell align="center">จำนวนเงิน งวดชำระ</StyledTableCell>
                                    <StyledTableCell align="center">จำนวนเงิน ค้างชำระ</StyledTableCell>
                                    <StyledTableCell align="center">สถานะใบเตือนหนี้ ครั้งที่</StyledTableCell>
                                </TableRow>
                            </TableHead>
                            <TableBody>
                            ...
                            {this.state.farmerPayLoanList.map((farmer, index) => {
                                    return (
                                        <TableRow key={index}>
                                            ...
                                            <StyledTableCellLine align="left">{farmer.row}</StyledTableCellLine>
                                            <StyledTableCellLine align="left">{farmer.projectName}</StyledTableCellLine>
                                            <StyledTableCellLine align="left">{farmer.loanNumber}</StyledTableCellLine>
                                            ...
                                            <StyledTableCellLine align="left">{farmer.budgetYear}</StyledTableCellLine>
                                            <StyledTableCellLine align="left">{farmer.principle}</StyledTableCellLine>
                                            <StyledTableCellLine align="left">{farmer.principalBalance}</StyledTableCellLine>
                                            <StyledTableCellLine align="left">{farmer.loanPeriodCode}</StyledTableCellLine>
                                            <StyledTableCellLine align="left">{farmer.installmentDate}</StyledTableCellLine>
                                            <StyledTableCellLine align="left">{farmer.payrec}</StyledTableCellLine>
                                            <StyledTableCellLine align="left">{farmer.stuckMoney}</StyledTableCellLine>
                                            <StyledTableCellLine align="left">{farmer.it}</StyledTableCellLine>
                                ...
                                <TableRow>
                                    ...
                                    <StyledTableCellLine align="right" className={`${classes.cellBlue} ${classes.cellSummary}`}>{formatNumber(dataSummary.principalBalance)}</StyledTableCellLine>
                                    <StyledTableCellLine align="left" className={`${classes.cellBlue} ${classes.cellSummary}`}></StyledTableCellLine>
                                    <StyledTableCellLine align="left" className={`${classes.cellBlue} ${classes.cellSummary}`}></StyledTableCellLine>
                                    <StyledTableCellLine align="left" className={`${classes.cellBlue} ${classes.cellSummary}`}>{formatNumber(dataSummary.payrec)}</StyledTableCellLine>
                                    <StyledTableCellLine align="left" className={`${classes.cellBlue} ${classes.cellSummary}`}>{formatNumber(dataSummary.StuckMoney)}</StyledTableCellLine>
                                    <StyledTableCellLine align="left" className={`${classes.cellBlue} ${classes.cellSummary}`}></StyledTableCellLine>
...
export default withStyles(styles)(WaivePerDateTab)