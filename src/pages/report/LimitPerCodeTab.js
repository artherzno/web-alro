...
parameter.append('YearTo', YearTovalue);
        ...
        api.getAgeByDay(parameter).then(response => {
    ...
    exportExcel() {
        ...
        api.exportLimitPerCode(parameter).then(response => {
    ...
    printPDF() {
        ...
        api.getAgeByDayPdf(parameter).then(response => {
                                ...
                                <TableRow>
                                    <StyledTableCellLine colSpan={3} align="center" className={`${classes.cellBlue} ${classes.cellSummary}`}>
                                        รวมทั้งสิ้น
                                            ...
                                            <StyledTableCellLine align="left" className={`${classes.cellBlue} ${classes.cellSummary}`}>{dataSummary.day7}</StyledTableCellLine>
                                            ...
                                            <StyledTableCellLine align="left" className={`${classes.cellBlue} ${classes.cellSummary}`}>{dataSummary.day8}</StyledTableCellLine>
                                            ...
                                            <StyledTableCellLine align="left" className={`${classes.cellBlue} ${classes.cellSummary}`}>{dataSummary.day9}</StyledTableCellLine>
                                            ...
                                            <StyledTableCellLine align="left" className={`${classes.cellBlue} ${classes.cellSummary}`}>{dataSummary.day10}</StyledTableCellLine>
