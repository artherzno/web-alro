...
class LimitPerCodeTab extends React.Component {
    ...
    exportExcel() {
        ...
        api.exportRequestLoan(parameter).then(response => {
            ...
            link.href = url;
            link.setAttribute('download', 'รายงานอายุความ(รายประเภทโครงการหลัก).xlsx');
    ...
    render() {
        ...
        return (<div>
            ...
            <div>
                <Box mt={5} mb={5}>
                    <Typography variant="h6" align="center">รายงานอายุความ (รายประเภทโครงการหลัก) {`${this.state.provinceZoneLabel}`}</Typography>
