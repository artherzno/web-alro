...
class LimitPerProvinceTab extends React.Component {
...
parameter.append('YearTo', YearTovalue);
        ...
        api.exportRequestLoan(parameter).then(response => {
            ...
            link.href = url;
            link.setAttribute('download', 'สรุปรายงานอายุความ.xlsx');
    ...
    render() {
        ...
        return (<div>
            ...
            <div>
                <Box mt={1} mb={5}>
                    <Typography variant="h6" align="center">สรุปรายงานอายุความ {`${this.state.provinceZoneLabel}`}</Typography>
...
export default withStyles(styles)(LimitPerProvinceTab)