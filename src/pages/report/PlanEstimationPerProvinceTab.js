...
class PlanEstimationPerProvinceTab extends React.Component {
...
parameter.append('YearTo', YearTovalue);
        ...
        api.getPlanEstimationByProvince(parameter).then(response => {
...
parameter.append('YearTo', YearTovalue);
        ...
        api.exportPlanEstimationPerProvince(parameter).then(response => {

            const url = window.URL.createObjectURL(new Blob([response.data]));
            const link = document.createElement('a');
            link.href = url;
            link.setAttribute('download', 'รายงานประมาณการแผนการจ่ายเงินกู้ (รายจังหวัด).xlsx');
    ...
    printPDF() {
        ...
        api.getPlanEstimationByProvincePdf(parameter).then(response => {
    ...
    render() {
        ...
        return (<div>
            ...
            <div>
                <Box mt={1} mb={5}>
                    <Typography variant="h6" align="center">รายงานประมาณการแผนการจ่ายเงินกู้ (รายจังหวัด) {`${this.state.provinceZoneLabel}`}</Typography>
            ...
            <Box mt={2}>
               ...
               <TableContainer>
                        <Table className={classes.table} aria-label="customized table">
                            <TableHead>
                            <TableRow>
                                    <StyledTableCell align="center" rowSpan={3}>จังหวัด</StyledTableCell>
...
export default withStyles(styles)(PlanEstimationPerProvinceTab)