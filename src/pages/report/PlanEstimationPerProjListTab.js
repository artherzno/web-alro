...
class PlanEstimationPerProjListTab extends React.Component {
    ...
    loadPayLoan(page, count) {
        ...
        api.getPlanEstimationByProject(parameter).then(response => {
    ...
    exportExcel() {
        ...
        api.exportPlanEstimationPerProjList(parameter).then(response => {
    ...
    printPDF() {
        ...
        api.getPlanEstimationByProjectPdf(parameter).then(response => {
                        ...
                        <Table className={classes.table} aria-label="customized table">
                            <TableHead>
                                <TableRow>
                                    ...
                                    <StyledTableCell align="center" rowSpan={3}>ชื่อโครงการ</StyledTableCell>
