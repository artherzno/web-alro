...
class LiabilityPerProjListTab extends React.Component {
...
parameter.append('YearTo', YearTovalue);
        ...
        api.getLiabilityPerProList(parameter).then(response => {
    ...
    exportExcel() {
        ...
        api.exportLiabilityPerProjList(parameter).then(response => {

            const url = window.URL.createObjectURL(new Blob([response.data]));
            const link = document.createElement('a');
            link.href = url;
            link.setAttribute('download', 'รายงานสภาพความรับผิด(รายโครงการ).xlsx');
...
export default withStyles(styles)(LiabilityPerProjListTab)