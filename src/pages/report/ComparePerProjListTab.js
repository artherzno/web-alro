...
parameter.append('YearTo', YearTovalue);
        ...
        api.getComparePerProject(parameter).then(response => {
...
parameter.append('YearTo', YearTovalue);
        ...
        api.exportComparePerProjList(parameter).then(response => {
    ...
    printPDF() {
        ...
        api.getComparePerProjectPdf(parameter).then(response => {
