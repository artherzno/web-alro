...
class CalendarYear1Tab extends React.Component {
...
parameter.append('YearTo', YearTovalue);
    ...
    exportExcel() {
        ...
        api.exportCalendarYear1(parameter).then(response => {

            const url = window.URL.createObjectURL(new Blob([response.data]));
            const link = document.createElement('a');
            link.href = url;
            link.setAttribute('download', 'รายงานปฎิทินใบเตือนหนี้ต้นครั้งที่ 1.xlsx');
    ...
    printPDF() {
        ...
        api.getCalendarDebt1Pdf(parameter).then(response => {
    ...
    render() {
        ...
        return (<div>
            ...
            <div>
                <Box mt={1} mb={5}>
                    <Typography variant="h6" align="center">รายงานปฎิทินใบเตือนหนี้ต้นครั้งที่ 1 {`${this.state.provinceZoneLabel}`}</Typography>
                        ...
                        <Table className={classes.table} aria-label="customized table">
                            <TableHead>
                                <TableRow>
                                    ...
                                    <StyledTableCell align="center" >สรุปรายงานการออกใบเตือนหนี้ ครั้งที่ 1</StyledTableCell>
...
export default withStyles(styles)(CalendarYear1Tab)