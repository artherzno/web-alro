...
class DebtClassPerContractTab extends React.Component {
...
parameter.append('YearTo', YearTovalue);
        ...
        api.exportDebtClassPerContract(parameter).then(response => {

            const url = window.URL.createObjectURL(new Blob([response.data]));
            const link = document.createElement('a');
            link.href = url;
            link.setAttribute('download', 'รายงานจัดชั้นหนี้.xlsx');
    ...
    printPDF() {
        ...
        api.getDebtClassPerContractPdf(parameter).then(response => {
    ...
    render() {
        ...
        return (<div>
            ...
            <div>
                <Box mt={1} mb={5}>
                    <Typography variant="h6" align="center">รายงานจัดชั้นหนี้ {`${this.state.provinceZoneLabel}`}</Typography>
                        ...
                        <Table className={classes.table} aria-label="customized table">
                            <TableHead>
                                <TableRow>
                                    ...
                                    <StyledTableCell align="center" rowSpan={2}>ชั้นหนี้</StyledTableCell>
...
export default withStyles(styles)(DebtClassPerContractTab)