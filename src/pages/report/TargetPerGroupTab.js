...
class TargetPerGroupTab extends React.Component {
...
parameter.append('YearTo', YearTovalue);
        ...
        api.exportTargetByGroup(parameter).then(response => {

            const url = window.URL.createObjectURL(new Blob([response.data]));
            const link = document.createElement('a');
            link.href = url;
            link.setAttribute('download', 'รายงานเป้าจัดเก็บกลุ่มลูกหนี้(รายสัญญา/โครงการ).xlsx');
    ...
    printPDF() {
        ...
        api.getTargetByDebtPdf(parameter).then(response => {
    ...
    render() {
        ...
        return (<div>
            ...
            <div>
                <Box mt={1} mb={5}>
                    <Typography variant="h6" align="center">รายงานเป้าจัดเก็บ กลุ่มลูกหนี้ (รายสัญญา/โครงการ) {`${this.state.provinceZoneLabel}`}</Typography>
                        ...
                        <Table className={classes.table} aria-label="customized table">
                            <TableHead>
                                <TableRow>
                                    ...
                                    <StyledTableCell align="center" rowSpan={2}>กลุ่มครบชำระ</StyledTableCell>
                                    <StyledTableCell align="center" rowSpan={2}>กลุ่มค้าง+ครบ</StyledTableCell>
...
export default withStyles(styles)(TargetPerGroupTab)