...
class PlanEstimationPerContractTab extends React.Component {
    ...
    loadPayLoan(page, count) {
        ...
        api.getPlanEstimationByContract(parameter).then(response => {
    ...
    exportExcel() {
        ...
        api.exportPlanEstimationPerContract(parameter).then(response => {

            const url = window.URL.createObjectURL(new Blob([response.data]));
            const link = document.createElement('a');
            link.href = url;
            link.setAttribute('download', 'รายงานประมาณการแผนการจ่ายเงินกู้.xlsx');
    ...
    printPDF() {
        ...
        api.getPlanEstimationByContractPdf(parameter).then(response => {
    ...
    render() {
        ...
        return (<div>
            ...
            <div>
                <Box mt={1} mb={5}>
                    <Typography variant="h6" align="center">รายงานประมาณการแผนการจ่ายเงินกู้  {`${this.state.provinceZoneLabel}`}</Typography>
               ...
               <Paper>
                    <TableContainer>
                        <Table className={classes.table} aria-label="customized table">
                            <TableHead>
                                <TableRow>
                                    <StyledTableCell align="center" rowSpan={3}>ชื่อ - นามสกุล</StyledTableCell>
                                    <StyledTableCell align="center" rowSpan={3}>เลขสัญญา</StyledTableCell>
...
export default withStyles(styles)(PlanEstimationPerContractTab)