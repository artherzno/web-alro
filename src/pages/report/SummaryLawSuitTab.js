                        ...
                        <Table className={classes.table} aria-label="customized table">
                            ...
                            <TableBody>
                                {this.state.farmerPayLoanList.map((farmer, index) => {
                                    ...
                                    return (
                                        <TableRow key={index}>
                                            ...
                                            <StyledTableCellLine align="left">{farmer.totalContract}</StyledTableCellLine>
                                ...
                                <TableRow>
                                    ...
                                    <StyledTableCellLine align="left" className={`${classes.cellBlue} ${classes.cellSummary}`}>{dataSummary.totalContract}</StyledTableCellLine>
