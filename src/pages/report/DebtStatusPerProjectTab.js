...
class DebtStatusPerProjectTab extends React.Component {
    ...
    exportExcel() {
        ...
        api.exportRequestLoan(parameter).then(response => {
            ...
            link.href = url;
            link.setAttribute('download', 'รายงานสถานะหนี้เงินกู้รายโครงการ.xlsx');
    ...
    printPDF() {
        ...
        api.getDebtStatusPerProjectPdf(parameter).then(response => {
    ...
    render() {
        ...
        return (<div>
            ...
            <div>
                <Box mt={1} mb={5}>
                    <Typography variant="h6" align="center">รายงานสถานะหนี้เงินกู้ รายโครงการ {`${this.state.provinceZoneLabel}`}</Typography>
...
export default withStyles(styles)(DebtStatusPerProjectTab)