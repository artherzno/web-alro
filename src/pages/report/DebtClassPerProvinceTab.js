...
class DebtClassPerProvinceTab extends React.Component {
    ...
    exportExcel() {
        ...
        api.exportRequestLoan(parameter).then(response => {
            ...
            link.href = url;
            link.setAttribute('download', 'สรุปรายงานจัดชั้นหนี้.xlsx');
    ...
    render() {
        ...
        return (<div>
            ...
            <div>
                <Box mt={5} mb={5}>
                    <Typography variant="h6" align="center">สรุปรายงานจัดชั้นหนี้ {`${this.state.provinceZoneLabel}`}</Typography>
...
export default withStyles(styles)(DebtClassPerProvinceTab)