...
class CashFlowPerProj3Tab extends React.Component {
    ...
    loadPayLoan(page, count) {
        ...
        api.getCashFlow3(parameter).then(response => {
    ...
    exportExcel() {
        ...
        api.exportCashFlowPerProj3(parameter).then(response => {
    ...
    printPDF() {
        ...
        api.getCashFlow3Pdf(parameter).then(response => {
                        ...
                        <Table className={classes.table} aria-label="customized table">
                            <TableHead>
                                <TableRow>
                                    ...
                                    <StyledTableCell align="center">เดือนนี้</StyledTableCell>
                                    <StyledTableCell align="center">ตั้งแต่ต้นปี</StyledTableCell>
                            ...
                            <TableBody>
                                {this.state.farmerPayLoanList.map((farmer, index) => {
                                    ...
                                    return (
                                        <TableRow key={index}>
                                            ...
                                            <StyledTableCellLine align="left">{farmer.thismonth}</StyledTableCellLine>
                                            <StyledTableCellLine align="left">{farmer.theyear}</StyledTableCellLine>
                                ...
                                <TableRow>
                                    ...
                                    <StyledTableCellLine align="right" className={`${classes.cellBlue} ${classes.cellSummary}`}>{formatNumber(dataSummary.thismonth)}</StyledTableCellLine>
...
export default withStyles(styles)(CashFlowPerProj3Tab)