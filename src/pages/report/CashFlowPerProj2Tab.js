...
class CashFlowPerProj2Tab extends React.Component {
    ...
    loadPayLoan(page, count) {
        ...
        api.getCashFlow2(parameter).then(response => {
    ...
    exportExcel() {
        ...
        api.exportCashFlowPerProj2(parameter).then(response => {
    ...
    printPDF() {
        ...
        api.getCashFlow2Pdf(parameter).then(response => {
    ...
    render() {
        ...
        return (<div>
            ...
            <div>
                <Box mt={1} mb={5}>
                    <Typography variant="h6" align="center">รายละเอียดประกอบงบกระแสดงเงินสด {`${this.state.provinceZoneLabel}`}</Typography>
                        ...
                        <Table className={classes.table} aria-label="customized table">
                            ...
                            <TableBody>
                                {this.state.farmerPayLoanList.map((farmer, index) => {
                                    ...
                                    return (
                                        <TableRow key={index}>
                                            ...
                                            <StyledTableCellLine align="left">{farmer.totalreceive}</StyledTableCellLine>
                                            <StyledTableCellLine align="left">{farmer.principle}</StyledTableCellLine>
                                            <StyledTableCellLine align="left">{farmer.accruedinterest}</StyledTableCellLine>
                                            <StyledTableCellLine align="left">{farmer.interestearned}</StyledTableCellLine>
                                            <StyledTableCellLine align="left">{farmer.overpay}</StyledTableCellLine>
                                ...
                                <TableRow>
                                    ...
                                    <StyledTableCellLine align="right" className={`${classes.cellBlue} ${classes.cellSummary}`}>{formatNumber(dataSummary.totalreceive)}</StyledTableCellLine>
                                    ...
                                    <StyledTableCellLine align="right" className={`${classes.cellBlue} ${classes.cellSummary}`}>{formatNumber(dataSummary.overpay)}</StyledTableCellLine>
...
export default withStyles(styles)(CashFlowPerProj2Tab)