...
class ComparePlanResultPerCodeTab extends React.Component {
    ...
    loadPayLoan(page, count) {
        ...
        api.getComparePlanResultByCode(parameter).then(response => {
    ...
    exportExcel() {
        ...
        api.exportComparePlanResultPerCode(parameter).then(response => {
    ...
    printPDF() {
        ...
        api.getComparePlanResultByCodePdf(parameter).then(response => {
                        ...
                        <Table className={classes.table} aria-label="customized table">
                            <TableHead>
                                <TableRow>
                                    ...
                                    <StyledTableCell align="center" rowSpan={2}>โครงการรอง</StyledTableCell>
