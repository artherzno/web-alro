...
class DebtClassPerProjListTab extends React.Component {
    ...
    exportExcel() {
        ...
        api.exportRequestLoan(parameter).then(response => {
            ...
            link.href = url;
            link.setAttribute('download', 'รายงานจัดชั้นหนี้(รายโครงการ).xlsx');
    ...
    render() {
        ...
        return (<div>
            ...
            <div>
                <Box mt={5} mb={5}>
                    <Typography variant="h6" align="center">รายงานจัดชั้นหนี้ (รายโครงการ) {`${this.state.provinceZoneLabel}`}</Typography>
...
export default withStyles(styles)(DebtClassPerProjListTab)