...
function RecordDebtContractStep3() {
    ...
    return (
        <div className="recorddebtcontract-step-page">
                    ...
                    <Container maxWidth="lg">
                        <Grid container spacing={2}>
                            <Grid item xs={12} md={12}>
                                ...
                                {/* Paper 1 - -------------------------------------------------- */}
                                <Paper className="paper line-top-yellow paper mg-t-20">
                                    <form className="root" noValidate autoComplete="off" onSubmit={handleSubmit}>
                                        <Grid container spacing={2}>
                                            ...
                                            <Grid item xs={12} md={3}>
                                                <MuiTextfield label="บันทึกแปลงหนี้ปี"  defaultValue="" />
                                            </Grid>
                                ...
                                {/* Paper 2 - -------------------------------------------------- */}
                                <Paper className="paper line-top-yellow paper mg-t-35">
                                    <form className="root" noValidate autoComplete="off" onSubmit={handleSubmit}>
                                    ...
                                    <form className="root" noValidate autoComplete="off" onSubmit={handleSubmit}>
                                        <Grid container spacing={2} className="paper-container">
                                            ...
                                            <Grid item xs={12} md={12} className="txt-center">
                                                 <ButtonFluidColor label="+ เพิ่ม" maxWidth="275px" color="yellow" />
                                            </Grid>
                                        </Grid>
                                    </form>
                                </Paper>
...
export default RecordDebtContractStep3
