...
function GuaranteeBookA() {
    ...
    useEffect(() => {
        ...
        let getGuaranteeBookALoanNumber = localStorage.getItem('GuaranteeBoookALoanNumber')
        let getGuaranteeBookALoanID = localStorage.getItem('GuaranteeBoookALoanID')
        if(!!getGuaranteeBookALoanNumber ) {
            getSearch(getGuaranteeBookALoanNumber, getGuaranteeBookALoanID) 
            setInputDataSearch({
                ...inputDataSearch,
                LoanNumber: getGuaranteeBookALoanNumber
            })
        }
    ...
    const getView = (gbookID,loanID,ind,fromOtherPage) => {
        ...
        if(gbookID === null) {
            console.warn('Add GuaranteeBookA')
            let dataView = {
                LoanID: loanID,
                GuaranteeBookTypeID: "1"
            }
            ...
            console.warn('Edit GuaranteeBookA')
            let dataView = {
                GBookID: gbookID
            }
    ...
    const handlePrintPDF = () => {
        ...
        axios({
        url: `${siteprint}/report/pdf/GetGuaranteeBookType1Pdf`, //your url
        method: 'POST',
        data: formData,
