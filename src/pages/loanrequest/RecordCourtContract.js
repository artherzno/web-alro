...
import RecordCourtContractStep3 from './RecordCourtContractStep3';
import RecordCourtContractStep4 from './RecordCourtContractStep4';
...
// Get Step Label
function getSteps() {
    return ['อนุมัติคำขอ', 'บันทึกฟ้องศาล', 'บันทึกสัญญาฟ้องศาล', 'ออกสัญญาเงินกู้ใหม่'];
}

function RecordCourtContract() {
            ...
            case 1:
                return <Redirect to={{
                    ...
                    state: { 
                        ...
                        typeSpecial: '1',
                        color: 'red',
                        page: 'recordcourtcontract'
                    }
                  }}/>
            case 2:
                return <RecordCourtContractStep3 />;
            case 3:
                return <RecordCourtContractStep4 />;
            default:
                return 'Unknown step';
        }
    }
    ...
    return (
        <div className="recordcourtcontract-page">
                                                    ...
                                                    <React.Fragment>
                                                        {activeStep !== steps.length && (completed[activeStep] ? (
                                                            <p variant="caption" className={classes.completed}>
                                                             ...
                                                             <ButtonFluidColor label="ยืนยันการเพิ่ม" maxWidth="615px" color="red" onClick={handleComplete} />
                                                        ))}
                                                    </React.Fragment>
                                            ))}
                                    </div>
...
export default RecordCourtContract
