...
import RecordDebtContractStep3 from './RecordDebtContractStep3';
import RecordDebtContractStep4 from './RecordDebtContractStep4';
...
// Get Step Label
function getSteps() {
    return ['อนุมัติคำขอ', 'บันทึกการแปลงหนี้', 'บันทึกสัญญาแปลงหนี้', 'ออกสัญญาเงินกู้ใหม่'];
}

function RecordDebtContract() {
            ...
            case 1:
                return <Redirect to={{
                    ...
                    state: { 
                        ...
                        typeSpecial: '2',
                        color: 'yellow',
                        page: 'recorddebtcontract'
                    }
                  }}/>
            case 2:
                return <RecordDebtContractStep3 />;
            case 3:
                return <RecordDebtContractStep4 />;
            default:
                return 'Unknown step';
        }
    }
    ...
    return (
        <div className="recorddebtcontract-page">
                                                    ...
                                                    <React.Fragment>
                                                        {activeStep !== steps.length && (completed[activeStep] ? (
                                                            <p variant="caption" className={classes.completed}>
                                                             ...
                                                             <ButtonFluidColor label="ยืนยันการเพิ่ม" maxWidth="615px" color="yellow" onClick={handleComplete} />
                                                        ))}
                                                    </React.Fragment>
                                            ))}
                                    </div>
...
export default RecordDebtContract
